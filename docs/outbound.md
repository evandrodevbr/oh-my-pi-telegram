...
3. registered voice synthesis providers from `@evandrodevbr/oh-my-pi-telegram/voice`
...
Voice replies can be delivered by synthesis providers registered through `@evandrodevbr/oh-my-pi-telegram/voice`:

```ts
import { registerTelegramVoiceSynthesisProvider } from "@evandrodevbr/oh-my-pi-telegram/voice";
