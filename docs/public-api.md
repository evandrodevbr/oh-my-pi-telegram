...
```ts
import telegram from "@evandrodevbr/oh-my-pi-telegram";
import { registerTelegramSection } from "@evandrodevbr/oh-my-pi-telegram/sections";
import { registerTelegramStatusLineProvider } from "@evandrodevbr/oh-my-pi-telegram/status";
import { registerTelegramUpdateHandler } from "@evandrodevbr/oh-my-pi-telegram/updates";
import { registerTelegramCommand } from "@evandrodevbr/oh-my-pi-telegram/commands";
import { registerTelegramInboundHandler } from "@evandrodevbr/oh-my-pi-telegram/inbound";
import { registerTelegramOutboundHandler } from "@evandrodevbr/oh-my-pi-telegram/outbound";
import { sendTelegramView } from "@evandrodevbr/oh-my-pi-telegram/delivery";
import { registerTelegramActivityHandler } from "@evandrodevbr/oh-my-pi-telegram/activity";
import {
  registerTelegramVoiceSynthesisProvider,
  registerTelegramVoiceTranscriptionProvider,
} from "@evandrodevbr/oh-my-pi-telegram/voice";
```

`0.12.0` intentionally removes the published `@evandrodevbr/oh-my-pi-telegram/lib/*.ts` compatibility wildcard. Integrations should use the public API domain subpaths above. Package exports point at `/api/*.ts` membranes that re-export only stable companion-extension symbols; implementation modules under `lib/` remain package-private. Telegram command extensions use `/commands` as an explicit opt-in surface instead of automatically exposing arbitrary Pi slash commands to Telegram. See [Public API Smoke Examples](#public-api-smoke-examples) below for minimal companion-extension patterns that avoid implementation imports.
...
Import from `@evandrodevbr/oh-my-pi-telegram/commands`. This registers Telegram slash commands only; it does not expose Pi slash commands and is unrelated to command-template handlers.
...
Import from `@evandrodevbr/oh-my-pi-telegram/sections`.
...
Import from `@evandrodevbr/oh-my-pi-telegram/delivery`.
...
Import from `@evandrodevbr/oh-my-pi-telegram/activity`.
...
Import from `@evandrodevbr/oh-my-pi-telegram/status`.
...
Import from `@evandrodevbr/oh-my-pi-telegram/updates`.
...
Import from `@evandrodevbr/oh-my-pi-telegram/inbound`.
...
Import from `@evandrodevbr/oh-my-pi-telegram/outbound`.
...
Import from `@evandrodevbr/oh-my-pi-telegram/voice`.
...
Minimal companion-extension examples that import only stable `@evandrodevbr/oh-my-pi-telegram/*` public membranes. Copy one into an extension `index.ts`, load it beside `pi-telegram`, and verify that it starts without importing any `@evandrodevbr/oh-my-pi-telegram/lib/*` implementation path.
...
- The extension imports only public package membranes: `@evandrodevbr/oh-my-pi-telegram`, `/commands`, `/sections`, `/status`, `/delivery`, `/activity`, `/updates`, `/inbound`, `/outbound`, `/voice`, or `/keyboard`.
- It does not import `@evandrodevbr/oh-my-pi-telegram/lib/*`.
